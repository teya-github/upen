...
class Listproject extends BaseController
{
	
    protected $listprojectModel;
    protected $validation;
	
	public function __construct()
	{
	    $this->listprojectModel = new ListprojectModel();
	...
	public function add()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->listprojectModel->insert($fields)) {
	...
	public function edit()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->listprojectModel->update($fields['id'], $fields)) {
	...
	public function remove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->listprojectModel->where('id', $id)->delete()) {
